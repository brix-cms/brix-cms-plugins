 ...
 */
public final class GalleryRootLocatorFactory extends AbstractLocatorFactory {

	static final String WORKSPACE_ROOT_PATH = "/brix:root/Gallery";

	/** {@inheritDoc} */
	public GalleryRootLocatorFactory(String pathPrefix) {
		super(pathPrefix);
	}
	...
	protected String getRepositoryPath(String resourcePath, String wspPath) {
		...
		if (resourcePath.equals(wspPath) || startsWithWorkspace(resourcePath, wspPath)) {
			String repositoryPath = WORKSPACE_ROOT_PATH + resourcePath.substring(wspPath.length());
	...
	protected String getResourcePath(String repositoryPath, String wspPath) {
		...
		String resourcePath = (startsWithWorkspace(repositoryPath, wspPath)) ? removeRootPrefix(repositoryPath)
	...
	private String removeRootPrefix(String repositoryPath) {
		if (repositoryPath.startsWith(WORKSPACE_ROOT_PATH)) {
			return repositoryPath.substring(WORKSPACE_ROOT_PATH.length());
		} else {
			return repositoryPath;
		}
	}
